...
> extends HttpClient<SecurityDataType> {
   ...
   * @tags otp-controller
   * @name VerifyEmail
   * @request POST:/api/v1/verify/verifyEmail
   */
  verifyEmail = (data: UserEmailDto, params: RequestParams = {}) =>
    this.request<ApiResponseVoid, any>({
      path: `/api/v1/verify/verifyEmail`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   * @request POST:/api/v1/verify/send-confirm-code
   */
  sendConfirmCode = (data: OtpCodeDto, params: RequestParams = {}) =>
    this.request<ApiResponseVoid, any>({
      path: `/api/v1/verify/send-confirm-code`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   * @tags otp-controller
   * @name ResetPassword
   * @request POST:/api/v1/verify/reset-password
   */
  resetPassword = (data: UserEmailDto, params: RequestParams = {}) =>
    this.request<ApiResponseVoid, any>({
      path: `/api/v1/verify/reset-password`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   */
  setNewPassword = (data: UserDto, params: RequestParams = {}) =>
   ...
   */
  register = (data: UserDto, params: RequestParams = {}) =>
    this.request<ApiResponseAuthResponseDto, any>({
